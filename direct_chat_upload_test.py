...
def run_direct_chat_upload_test():
    ...
    # Test users
    user1 = {"name": "DirectTester1", "email": "directtester1@example.com", "password": "TestPass123!"}
    user2 = {"name": "DirectTester2", "email": "directtester2@example.com", "password": "TestPass123!"}
