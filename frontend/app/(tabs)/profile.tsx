          ...
          <View style={styles.modernTabContent}>
            ...
            >
              ...
              <View style={styles.modernActionGrid}>
                ...
                <TouchableOpacity style={{backgroundColor: "#059669", padding: 16, borderRadius: 16, width: "48%", alignItems: "center", minHeight: 80, justifyContent: "center"}} onTouchStart={() => {alert("Privacy Policy CLICKED!"); router.push("/privacy-policy")}}>
